<template>
  <v-container>
    <h2> - 概要</h2>
    <p>アプリ開発担当・インフラ担当・コンサルタントとして業務を経験致しました。 開発案件からコンサルティングジョブまで幅広く入ったことがあります。 事業を加速させるようなインフラの構築・セキュリティ対策を目標としておりDevSec/Opsを実現したいです。また新規サービス開発もチャレンジしたいです。</p>
    <h2> - 言語</h2>
